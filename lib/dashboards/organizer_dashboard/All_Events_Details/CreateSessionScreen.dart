        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              const SizedBox(height: 10),
              ListTile(
                title: Text(_startTime == null ? 'Pick Start Time' : 'Start: ${_startTime!.format(context)}'),
                trailing: const Icon(Icons.access_time),
                onTap: () => _pickTime(true),
              ),
              ListTile(
                title: Text(_endTime == null ? 'Pick End Time' : 'End: ${_endTime!.format(context)}'),
                trailing: const Icon(Icons.access_time),
              ...
              ElevatedButton(
                ...
                child: _isSubmitting ? const CircularProgressIndicator() : const Text('Create Session'),
              ),
            ],
          ),
        ),
